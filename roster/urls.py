...
urlpatterns = [
    ...
    path('edit_full_roster/', include('b_ball.urls')),
    path('delete/', include('b_ball.urls')),
    path('delete_full_list/', include('b_ball.urls')),
    ...
    path('crud_base/', include('b_ball.urls')),
    path('register_full_list/', include('b_ball.urls')),
